...
namespace devicestate {
     ...
     *
     * Cette classe extrait la logique de gestion des requêtes INFO du composant CN105State
    ...
    public:
        ...
        /**
         * @brief Type de callback pour obtenir le contexte CN105State (pour canSend et onResponse)
         * @return Pointeur vers CN105State (peut être nullptr)
         */
         ...
         * @param context_callback Callback pour obtenir le contexte CN105State (pour canSend et onResponse)
         */
        RequestScheduler(
         ...
         * @param context Contexte CN105State pour vérifier canSend (peut être nullptr, utilise context_callback_ si fourni)
         */
         ...
         * @param context Contexte CN105State pour appeler onResponse (peut être nullptr)
         */
         ...
         * @param context Contexte CN105State pour appeler onResponse (peut être nullptr, utilise context_callback_ si fourni)
    ...
    private:
        ...
        ContextCallback context_callback_;            // Callback pour obtenir le contexte CN105State

        /**
         * @brief Envoie une requête spécifique par son code
         * @param code Le code de la requête à envoyer
         * @param context Contexte CN105State pour vérifier canSend (peut être nullptr)
         */

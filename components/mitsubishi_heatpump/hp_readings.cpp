...
*/
void CN105Protocol::initBytePointer() {
 ...
 */
void CN105Protocol::parse(uint8_t inputData) {
...
bool CN105Protocol::checkSum() {
    // TODO: use the CN105Protocol::checkSum(byte bytes[], int len) function
...
void CN105Protocol::checkHeader(uint8_t inputData) {
    if (this->bytesRead == 4) {
...
bool CN105Protocol::processInput(void) {
...
void CN105Protocol::processDataPacket() {
...
void CN105Protocol::getAutoModeStateFromResponsePacket() {
...
void CN105Protocol::getPowerFromResponsePacket() {
...
void CN105Protocol::getSettingsFromResponsePacket() {
    heatpumpSettings receivedSettings{};
...
void CN105Protocol::getRoomTemperatureFromResponsePacket() {
...
void CN105Protocol::getOperatingAndCompressorFreqFromResponsePacket() {
...
void CN105Protocol::getHVACOptionsFromResponsePacket() {
    //MSZ-LN25VG2W
...
void CN105Protocol::terminateCycle() {
...
void CN105Protocol::getDataFromResponsePacket() {
...
void CN105Protocol::updateSuccess() {
...
void CN105Protocol::processCommand() {
    switch (this->command) {
...
void CN105Protocol::statusChanged(heatpumpStatus status) {
...
void CN105Protocol::publishStateToHA(heatpumpSettings& settings) {
...
void CN105Protocol::heatpumpUpdate(heatpumpSettings& settings) {
...
void CN105Protocol::checkVaneSettings(heatpumpSettings& settings, bool updateCurrentSettings) {
...
void CN105Protocol::checkWideVaneSettings(heatpumpSettings& settings, bool updateCurrentSettings) {
...
void CN105Protocol::updateExtraSelectComponents(heatpumpSettings& settings) {
...
void CN105Protocol::checkFanSettings(heatpumpSettings& settings, bool updateCurrentSettings) {
    /*
         * ******* HANDLE FAN CHANGES ********
         *
...
void CN105Protocol::checkPowerAndModeSettings(heatpumpSettings& settings, bool updateCurrentSettings) {

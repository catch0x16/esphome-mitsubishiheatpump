...
void CN105Protocol::writePacket(uint8_t* packet, int length, bool checkIsActive) {
...
void CN105Protocol::try_write_pending_packet() {
...
const char* CN105Protocol::getModeSetting() {
...
const char* CN105Protocol::getPowerSetting() {
...
const char* CN105Protocol::getVaneSetting() {
...
const char* CN105Protocol::getWideVaneSetting() {
...
const char* CN105Protocol::getFanSpeedSetting() {
...
float CN105Protocol::getTemperatureSetting() {
...
const char* CN105Protocol::getAirflowControlSetting() {
...
bool CN105Protocol::getAirPurifierRunState() {
...
bool CN105Protocol::getNightModeRunState() {
...
bool CN105Protocol::getCirculatorRunState() {
...
void CN105Protocol::createPacket(uint8_t* packet) {
...
void CN105Protocol::publishWantedSettingsStateToHA() {
...
void CN105Protocol::publishWantedRunStatesStateToHA() {
 ...
 *
*/
void CN105Protocol::sendWantedSettings() {
...
#else
            this->emulateMutex("WRITE_SETTINGS", std::bind(&CN105Protocol::sendWantedSettingsDelegate, this));
...
void CN105Protocol::buildAndSendRequestPacket(int packetType) {
...
void CN105Protocol::buildAndSendInfoPacket(uint8_t code) {
    uint8_t packet[PACKET_LEN] = {};
...
void CN105Protocol::buildAndSendRequestsInfoPackets() {
    if (this->isHeatpumpConnected_) {
...
void CN105Protocol::sendRemoteTemperature() {
...
void CN105Protocol::sendWantedRunStates() {
    uint8_t packet[PACKET_LEN] = {};

    ...
    hw_serial_{hw_serial}
{
    ...
    device_status_input_power->set_state_class(StateClass::STATE_CLASS_MEASUREMENT);
    ...
    device_status_kwh->set_state_class(StateClass::STATE_CLASS_TOTAL_INCREASING);
    ...
    device_status_runtime_hours->set_state_class(StateClass::STATE_CLASS_TOTAL_INCREASING);
